      ...
      <div>
        ...
        <div className="mt-2 flex flex-wrap items-start gap-3">
          ...
          <button
            ...
            aria-label="개인 설정"
            title="개인 설정"
            className="hidden h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-800 md:inline-flex"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
      ...
      <div className="flex flex-col items-stretch gap-3 md:items-end">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            aria-label="개인 설정"
            title="개인 설정"
            className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-600 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-800 md:hidden"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
